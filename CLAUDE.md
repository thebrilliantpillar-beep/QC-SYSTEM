...
### 8-2-1. AQL 표기는 두 줄 (2026-08-23, 2026-09-08 표기 간소화)
...
**2026-09-08 확정**: 첫 줄은 `[숫자]`처럼 대괄호로 감싸고, 둘째 줄의 "샘플 N개/"는
뺐다 — 샘플 수량은 바로 옆 D열("샘플 수량")에 이미 따로 나오는데 여기서 또 반복하니
중복이었다. 사용자 확정: "Pass 기준이 Ac가 몇 개인지, 무결점인지만 확인하면 된다."
